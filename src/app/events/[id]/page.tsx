...
export default function EventDetails() {
  ...
  if (!event) return <Typography variant="body1" color="textSecondary">No event found</Typography>;
      ...
      <div className="w-full flex flex-wrap mb-3 justify-center">
        <Box className="flex-1 mr-2">
          {isEditing ? (
            ...
            <EventDetailsDisplay event={event} handleEditClick={handleEditClick} handleDelete={() => handleDelete(id)} />
          )}
